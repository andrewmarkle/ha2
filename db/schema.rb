...
ActiveRecord::Schema.define(version: 20160503142816) do
  ...
  create_table "taxes", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.string   "name"
    t.integer  "rate"
    t.uuid     "company_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_taxes_on_company_id", using: :btree
  end
  ...
  add_foreign_key "taxes", "companies"
end
